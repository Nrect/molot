...
0. **[docs/TEXTBOOK.md](docs/TEXTBOOK.md)** — мини-учебник: ПОЧЕМУ здесь такая архитектура, золотые правила с обоснованием (проблема → наивное решение → почему болит → как сделано тут). Начинай отсюда, если нужна логика решений, а не только структура.
