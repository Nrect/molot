...
0. **[docs/book/](docs/book/README.md)** — полноценная книга: 18 углублённых глав (стратегия → ядро → интеграция → качество → перспектива), каждая на реальных выдержках кода этого репозитория, для разработчиков middle/senior. **[docs/TEXTBOOK.md](docs/TEXTBOOK.md)** — её сжатый конспект: золотые правила с обоснованием.
...
Код — MIT; документация и книга — **CC BY 4.0**: использовать, изучать и адаптировать можно свободно, но цитирование и заимствование этих материалов в статьях, курсах и докладах **требует указания автора и ссылки на репозиторий**. Подробности — в [LICENSE](LICENSE).
