...
- [ ] Маппинг «команда → агрегат → хендлер» существует, и каждая команда занимает ровно одну строку — без «ну, эта особенная».
